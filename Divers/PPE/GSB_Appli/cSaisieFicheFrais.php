 ...
 */
 ...
 /* if (!estVisiteurConnecte()) {
  ...
  // acquisition des quantites des elements forfaitisees 
  ...
  // structure de décision sur les differentes etapes du cas d'utilisation
  if ($etape == "validerSaisie") { 
      ...
      if (!$ok) {
          ajouterErreur($tabErreurs, "Chaque quantite doit etre renseignée et numérique positive.");
      }
      else { // mise à jour des quantites des elements forfaitisees
  ...
  elseif ($etape == "validerAjoutLigneHF") {
      ...
      if ( nbErreurs($tabErreurs) == 0 ) {
          // la nouvelle ligne ligne doit etre ajoutée dans la base de donnees
...
<?php
      ...
      <p>
        <input id="ok" type="submit" value="Valider" size="20" 
               title="Enregistrer les nouvelles valeurs des elements forfaitisees" />
   	...
   	<table class="listeLegere">  
    	<div>
      		<h2>Descriptif des elements hors forfait</h2>
		</div>
